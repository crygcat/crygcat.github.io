...
$.ajax({
    ...
    data: {
        key: 'JL6BZ-RZSOD-OV646-HIPEQ-KCN55-UJBD4',
        output: 'jsonp',
    },
    dataType: 'jsonp',
    success: function (res) {
        ...
        function showWelcome() {
            //这里记录你自己的经纬度
            let dist = getDistance(119.92429, 31.02159, ipLoacation.result.location.lng, ipLoacation.result.location.lat);
            ...
            document.getElementsByClassName("announcement_content")[0].innerHTML =
                `欢迎来自<span>${pos}</span>的小伙伴<br>
				${timeChange}<br>
				你距离 在流浪的猫 约有<span>${dist}</span>公里，${posdesc}
			`;
        }
        showWelcome()
    }
